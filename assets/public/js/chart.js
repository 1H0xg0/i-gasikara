...
function init_map() {
	console.log('call');
	map = new OpenLayers.Map("mapChart");
	...
	map.events.register("click", map, function(e) {
		...
		if(region != undefined) {
			...
			var html = "<h4>Données de la région "+region+"</h4>"+
				"<ul>"+
					"<li>Site de télécom : *******</li>"+
					"<li>Réseaux cellulaires: "+(rand <= 1 ? "Telma</li>" : (rand == 2 ? "Telma, Airtel</li>" : "Telma, Airtel, Orange</li>"))+
					"<li>Plans logistiques de déploiement: une stratégie spéciale</li>"+
					"<li>Bureau de vote et entrepot CENI: **********</li>"+
					"<li>Zones sensibilisées </li>"+ 
					"<li>Zones à sensibiliser: "+(rand <= 1 ? "oui</li>" : "non</li>")+
					"<li>Sécurité électorale: à prendre en main</li>"+
					"<li>Élection: nombre d’électeurs, taux de participation, résultat</li>"+
				"</ul>";

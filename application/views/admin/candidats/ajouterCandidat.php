<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-2 d-flex justify-content-end">
            <button id="btn-valider-ajout-candidat" type="button" class="btn waves-effect waves-light btn-rounded btn-success">
        ...
        <div class="card-body">
            <form class="form-material row" id="form-ajouter-candidat">
                ...
                <div class="form-group col-md-4 m-t-20">
                    ...
                    <input id="nomCandidat" type="text" class="form-control form-control-line" value=""> </div>
                <div class="form-group col-md-4 m-t-20">
                    <label for="prenomCandidat">Prenom(s) </labe>
                    <input id="prenomCandidat" type="text" class="form-control form-control-line" value=""> </div>


                <div class="form-group col-md-4 m-t-20">
                    <label for="ageElecteur">Age </labe>
                    <input id="ageElecteur" type="text" class="form-control form-control-line" value=""> </div>
                <div class="form-group col-md-4 m-t-20">
                    <label for="CINCandidat">CIN *</labe>
                    <input id="CINCandidat" type="text" class="form-control form-control-line" value=""> </div>
                <div class="form-group col-md-4 m-t-20">
                    <label for="adresseElecteur">Adresse électeur </labe>
                    <input id="adresseElecteur" type="text" class="form-control form-control-line" value=""> </div>

                <div class="form-group col-md-4 m-t-20">
                    <label for="abrevpartieCandidat">Abréviation du parti politique</labe>
                    <input id="abrevpartieCandidat" type="text" class="form-control form-control-line" value=""> </div>
                <div class="form-group col-md-4 m-t-20">
                    <label for="partieCandidat">Nom du parti politique</labe>
                    <input id="partieCandidat" type="text" class="form-control form-control-line" value=""> </div>
                <!--<div class="form-group col-md-4 m-t-20">
                ...
                <div class="form-group col-md-12 m-t-20">
                    ...
                    <textarea id="programmeCandidat" class="form-control" rows="5"></textarea>
                </div>
